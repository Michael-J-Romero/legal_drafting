...
type TabView = 'main-chat' | 'notes' | 'plan' | 'documents' | 'goals';

export default function PlanningAgentPage() {
  const [activeTab, setActiveTab] = useState<TabView>('main-chat');
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', padding: '8px 16px', borderBottom: '2px solid #e5e7eb', backgroundColor: '#fff' }}>
        <div style={{ display: 'flex', gap: 4 }}>
          <button
            onClick={() => setActiveTab('main-chat')}
            style={{
              padding: '8px 20px',
              backgroundColor: activeTab === 'main-chat' ? '#3b82f6' : 'transparent',
              color: activeTab === 'main-chat' ? 'white' : '#6b7280',
              border: 'none',
              borderRadius: 6,
              cursor: 'pointer',
              fontWeight: 600,
          ...
          <button
            ...
            style={{
              padding: '8px 20px',
              backgroundColor: activeTab === 'notes' ? '#3b82f6' : 'transparent',
          ...
          <button
            ...
            style={{
              padding: '8px 20px',
              backgroundColor: activeTab === 'plan' ? '#3b82f6' : 'transparent',
              color: activeTab === 'plan' ? 'white' : '#6b7280',
              border: 'none',
              borderRadius: 6,
              cursor: 'pointer',
              fontWeight: 600,
      ...
      {/* Main Content Area - show different views based on active tab */}
      {activeTab === 'main-chat' && (
